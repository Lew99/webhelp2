...
const LiganHeader = styled.h1`
  ...
  @keyframes glow {
    from {
      text-shadow: 0 0 2px var(--main-text-color);
    }
    to {
      text-shadow: 0 0 3px var(--main-text-color), 0 0 3px var(--main-text-color);
    }
  }
...
const Home = (props: HomeProps) => {
    ...
    return (
        <main>
            <MainContainer>
                <WalletContainer>
                    <Logo><li><a href="https://www.liga-nft.com/" target="_blank" rel="noopener noreferrer">LIGANFT</a> </li></Logo>
                    <Menu>
                ...
                <MintContainer>
                    ...
                    <MintButtonContainer>
                        {/* <NFT elevation={3}> */}
                            ...
                            <LiganHeader>LIGANFT</LiganHeader>
